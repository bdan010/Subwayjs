...
//create lines
UniversityLine = new Line( '#ffcc00', 'University');
Job1Line = new Line( '#ff7f2a', 'Job1');
...
//var dUWP = new DashLine( Job1Line['color'], new Point( W_SLC+2*SLC_delta + 100, H_SLC+SLC_delta + 55)+ new Point( +75, 0),  new Point( W_SLC+2*SLC_delta + 100, H_SLC+SLC_delta + 55)  );


clv = new SingleNode( Job1Line, new Point( W_SLC - 3*SLC_delta/2, H_SLC - 2*SLC_delta/2), null, 'CLV', '/', new Point(25, 0), 0);
rev = new SingleNode( Job1Line, new Point( W_SLC - 2*SLC_delta/2, H_SLC - 1*SLC_delta/2), null, 'REV', '/', new Point(15,-18), 0);
v1 = new SingleNode( Job1Line, new Point( W_SLC - 1*SLC_delta/2, H_SLC - 1*SLC_delta/2), null, 'V1', '/', new Point(15,-18), 0);

slc = new TransitionNode(  UniversityLine, Job1Line,3.8, new Point( W_SLC, H_SLC ), null, 'SLC','/', new Point( -65, 15), 0 );
    dp2 = new TransitionNode( NLine, EVLine,  -4.2, new Point( W_SLC+SLC_delta, H_SLC + SLC_delta/2), null, '', '/', new Point(20, -7), 0);

    dp = new TransitionNode( NLine, Job1Line,  .2, new Point( W_SLC+SLC_delta, H_SLC + SLC_delta/2), null, 'DP Library', '/', new Point(24, -15), 0);
    
    cif = new SingleNode( NLine, new Point( W_SLC+SLC_delta, H_SLC-160), null, 'CIF', '/', new Point(23,5), 0);
bmh = new TransitionNode(  UniversityLine, NLine, 4.75, new Point( W_SLC+SLC_delta, H_SLC-70 ), null, 'BMH','/', new Point(25, -10), 0 );

    
UniversityLine.path.closePath();




clv.neighbours = { 'S':rev, 'E': rev};
seagram.neighbours = { 'N':rev};;
...
var lg1 = new LegendItem( new Point( 60,300), new Point( 170,300), UniversityLine);
var lg2 = new LegendItem( new Point( 60,330), new Point( 170,330), Job1Line);
